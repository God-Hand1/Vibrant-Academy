window.MUSIC_LIBRARY = [
    // Songs/Song folder (Categorized as Mix/Hits)
    { id: 1, title: 'Bargad', src: 'Songs/Song/Bargad.mp3', folder: 'Mix', artist: 'Sufr & Arpit Bala' },
    { id: 2, title: 'Blinding Lights', src: 'Songs/Song/Blinding Lights.mp3', folder: 'Mix', artist: 'The Weeknd' },
    { id: 3, title: 'Chaandni', src: 'Songs/Song/Chaandni.mp3', folder: 'Mix', artist: 'Arijit Singh' },
    ...
    { id: 11, title: 'Kangna Tera Ni', src: 'Songs/Song/Kangna Tera Ni.mp3', folder: 'Mix', artist: 'Dr. Zeus' },
    { id: 12, title: 'Pata Chalgea', src: 'Songs/Song/Pata Chalgea.mp3', folder: 'Mix', artist: 'Imran Khan' },
    { id: 13, title: 'Suzume', src: 'Songs/Song/Suzume.mp3', folder: 'Mix', artist: 'Radwimps' },

    // Songs/Sad folder (Categorized as Sad)
    { id: 14, title: '9_45', src: 'Songs/Sad/9_45.mp3', folder: 'Sad', artist: 'Prabh Singh' },
    { id: 15, title: 'Aaja We Mahiya', src: 'Songs/Sad/Aaja We Mahiya.mp3', folder: 'Sad', artist: 'Imran Khan' },
    { id: 16, title: 'Aankhon Aankhon', src: 'Songs/Sad/Aankhon Aankhon.mp3', folder: 'Sad', artist: 'Yo Yo Honey Singh' },
    { id: 17, title: 'Attraction Slowed', src: 'Songs/Sad/Attraction Slowed.mp3', folder: 'Sad', artist: 'PinkPantheress' },
    { id: 18, title: 'Be Mine', src: 'Songs/Sad/Be Mine.mp3', folder: 'Sad', artist: 'Ofenbach' },
    { id: 19, title: 'Broken Angel', src: 'Songs/Sad/Broken Angel.mp3', folder: 'Sad', artist: 'Arash ft. Helena' },
